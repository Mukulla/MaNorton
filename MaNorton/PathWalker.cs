...
namespace MaNorton
{
    //Клас для спуска или подъёма по уровням папок
    class PathWalker
    {
        //Текущий путь
        string CurrentPath = "";
        ...
        public void Init(string FilePath001, int NumberOfPart)
        {
            ...
            string[] FileContent;
            //Проверка на существование файла, а так же именно двух записей, которые должны указывать на существующие пути
